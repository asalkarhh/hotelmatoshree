...
export function Navbar() {
  ...
  const navLinks = [
    { label: T(n.home),     to: "/" },
    { label: T(n.about),    to: "/about" },
    { label: T(n.menu),     to: "/menu" },
    { label: T(n.branches), to: "/branches" },
    { label: T(n.gallery),  to: "/gallery" },
    {
      label: T(n.franchises),
      to: "#",
      children: [
        { label: T(n.hotelFranchise), to: "/hotel-franchise" },
        { label: T(n.teaFranchise),   to: "/tea-franchise" },
      ],
    },
    { label: T(n.contact),  to: "/contact" },
  ];
